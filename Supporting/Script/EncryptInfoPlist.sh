...
SOURCE_PATH="${SRCROOT}/WeatherShared/Configs/Source/"

ENVIRONMENTS=("Debug" "Release")
SOURCE_FILES=($DEBUG_FILE_NAME $RELEASE_FILE_NAME)
TARGET_FILES=("${SRCROOT}/WeatherShared/Configs/weather-$DEBUG_FILE_NAME" "${SRCROOT}/WeatherShared/Configs/weather-$RELEASE_FILE_NAME")
